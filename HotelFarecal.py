...
class hotelfarecal:
    ...
    def __init__(self,rt='',s=0,p=0,r=0,t=0,a=0,name='',address='',cindate='',coutdate='',rno=101):
    ...
    def inputdata(self):
        ...
        self.address=input("\nEnter your address:")
        now=datetime.now()
        self.cindate= now.strftime("%d/%m/%Y %H:%M:%S")
        self.coutdate= int(input("\nNumber of days:"))
        self.d1=int(now.strftime("%d"))
        self.d2=int(now.strftime("%m"))
        self.d1=self.d1+self.coutdate
        if(self.d1>31 and self.d2%2 != 0 or self.d2==8):
            self.d1= self.d1 - 31
            self.d2= self.d2 + 1
        elif(self.d2%2==0 or self.d2 != 8 and self.d1>30):
            self.d1= self.d1 - 30
            self.d2= self.d2 + 1
    ...
    def display(self):
        ...
        print ("Check out date",self.d1,"/",self.d2,now.strftime("/%Y"))
